...
class AWSPriceRetriever(PriceRetriever):
    ...
    def fetch_current_pricing(self) -> dict:
        ...
        parameters = {"vendor": "aws", "service": "AWSLambda", "family": "Serverless", "region": self.region, "type": "AWS-Lambda-Requests", "purchaseOption": "on_demand"}
        ...
        self.DBClient.add_document_to_collection_if_not_exists("pricing", "AWS", current_pricing, {"request_price" : request_price, "duration_price": duration_price, "region" : self.region})
