...
class FittingFunction:
    ...
    def fit(self, datapoints: list) -> None:
        ...
        memories = np.array([datapoint.memory for datapoint in datapoints], dtype=np.int)
        billed_time = np.array([datapoint.billed_time for datapoint in datapoints], dtype=np.double)
