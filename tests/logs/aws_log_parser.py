...
class TestAWSLogParser(unittest.TestCase):
    ...
    def test_log_parsing(self):
        string_to_parse = "b'START RequestId: 03d92713-a4b2-4b07-a07a-653087817262 " \
                          "Version: $LATEST\\n" \
        ...
        self.assertDictEqual({'Duration': 18179.84, 'Billed Duration': 18180.0, 'Max Memory Used': 506.0, 'Memory Size': 512.0}, res)
